...
Public Class Approved_User_Control
    Protected Sub updateFunc2(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Teacher_Homepage.Btn_Approved_Click()
    ...
    Private Sub Approved_User_Control_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Label2.Visible = False
        Dim i As Integer = 1
        Dim cn As OleDbConnection = New OleDbConnection(Form_Main.connectString)
        cn.Open()
        Dim selectString As String = "SELECT * FROM Student_App_Table where Teacher_Username='" & Form_Main.input_user & "' AND Student_Approved= 'YES' ORDER BY Student_Name"
